...
correo = official[0][0] == String(contact[0]) ? 'Aldair' : official[1][0] == String(contact[0]) ? 'Aldair' : official[2][0] == String(contact[0]) ? 'indefinido202@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'Aldair' : official[1][0] == String(contact[0]) ? 'Aldair' : official[2][0] == String(contact[0]) ? 'Aldair' : official[3][0] == String(contact[0]) ? 'Aldair' : md 
